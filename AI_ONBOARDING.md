# AI Onboarding - Documentation Repository
...
- Development guides and test credentials
- Deployment and operations documentation
- Security policies

## Start Here
1. Read `business/MVP_ROADMAP.md` for the product vision
2. Read `business/REQUERIMIENTOS.md` for detailed requirements
3. Read `architecture/ARCHITECTURE.md` for technical overview
