...
- business/ - Business model, requirements, use cases, user roles
- architecture/ - System architecture, ADRs
- development/ - Dev guides, test users, version management
- operations/ - Deployment, GCP, observability
- security/ - Secrets management, CI/CD security
- project/ - Project status and history

## Guidelines
- Documentation language: Spanish
- Code examples language: English
